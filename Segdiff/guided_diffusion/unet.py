...
#     checkpoint,
# )
from guided_diffusion.RRDB import RRDBNet
...
class UNetModel(nn.Module):
    def __init__(
        ...
        self.rrdb = RRDBNet(in_nc=cond_img_ch,nb=rrdb_blocks, out_nc=model_channels)
...
#         rrdb_blocks=3,
#     )
#     x = th.rand((1, 1, 256, 256))
#     timesteps = th.rand(1)
#     cond_img  = th.rand((1, 1, 256, 256))
    
#     out = model(x, timesteps, conditioned_image=cond_img)
#     print(out.shape)
