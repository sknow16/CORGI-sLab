...
class PositionEncoder(nn.Module):
    ...
    def __init__(self, in_ch, hidden_ch=32):
        ...
        self.conv5 = ResBlock(hidden_ch*8, hidden_ch*16, 100)
        self.conv6 = ResBlock(hidden_ch*16, hidden_ch*16, 100)
    ...
    def forward(self, x):
        ...
        x = self.down(x5)  # (256, 8, 8) -> (256, 4, 4)
        x6 = self.conv6(x, None) # (256, 4, 4)
        return x3, x4, x5, x6
...
class UNet(nn.Module):
    def __init__(self, in_ch=1, out_ch=1, cond_in_ch=1 ,hidden_ch=32, time_embed_dim=100):
        ...
        self.down3 = ResBlock(hidden_ch*4+hidden_ch*16, hidden_ch*8, time_embed_dim)

        self.bot1  = ResBlock(hidden_ch*8+hidden_ch*16, hidden_ch*8, time_embed_dim)
