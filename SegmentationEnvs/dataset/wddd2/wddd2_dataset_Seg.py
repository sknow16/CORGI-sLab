...
class SegWDDD2Dataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        image_path = os.path.join('/root/save/dataset/WDDD2_Seg2Dnew/annotation_image/images', path) + '.tiff'
        mask_path = os.path.join('/root/save/dataset/WDDD2_Seg2Dnew/annotation_image/annotation', path) + '.png'
